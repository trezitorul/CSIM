...
tCoil(Dr,Width,r0)=Coil(theta->linSpiral(Dr,Width,r0,theta)[1],theta->dLinSpiral(Dr,Width,r0,theta),0,linSpiral(Dr,Width,r0,0)[2],4949.28)
asb1=Assembly([tCoil(.0052,.0254,.0254)])
asb2=Assembly([translate(tCoil(.0052,.0254,.0254),[0,0,.001])])
...
#plotter(stack,.1)
force=lorentzForce(asb1,[asb2])[3]
print(force/10^7)
