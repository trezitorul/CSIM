...
println("hello")
force=lorentzForce(tCoil1(0.0001294,.0254,.0254),translate(tCoil2(0.0001294,.0254,.0254),[0,0,.0001]))
...
toc()
@profile lorentzForce(tCoil1(0.0001294,.0254,.0254),translate(tCoil2(0.0001294,.0254,.0254),[0,0,.0001]))
