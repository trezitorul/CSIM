...
translate!(c::linSpiral, r::Vector3{Float64}) = (c.offset=c.offset+r)#Translates by a vector r in space, note this operates in place on the spiral (useful if doing computation were memallocs would be costly)
